...
- [x] 2026-04-30 Add `frame-ancestors 'none'` and `form-action 'self'` to CSP in next.config.ts — defense-in-depth against clickjacking + form hijack beyond X-Frame-Options [security] ✅
