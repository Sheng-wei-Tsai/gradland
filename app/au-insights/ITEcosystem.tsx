...
const LAYERS = [
  ...
  },
  {
    ...
    color: 'var(--gold)',
    borderColor: 'rgba(200,138,20,0.3)',
  ...
  },
  {
    ...
    label: 'Consultancies',
    color: 'var(--jade)',
    borderColor: 'rgba(30,122,82,0.3)',
    bgColor: 'rgba(30,122,82,0.04)',
    dotColor: 'var(--jade)',
...
const DECISION_ROWS = [
  ...
  { goal: 'Cloud certifications + infrastructure career', layer: 'Layer 2 — Integrators', color: 'var(--gold)' },
  { goal: 'Variety, client exposure, fast structured promotion', layer: 'Layer 3 — Consultancies', color: 'var(--jade)' },
