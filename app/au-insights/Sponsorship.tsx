  ...
  return (
    <div style={{ paddingBottom: '4rem' }}>
      ...
      <div style={{
        ...
        <a href="https://www.data.gov.au/data/dataset/visa-temporary-work-skilled" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--gold)' }}>
        ...
        <a href="https://github.com/geshan/au-companies-providing-work-visa-sponsorship" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--gold)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: '0.8rem', marginBottom: '1.5rem' }}>
        {[
          ...
          { label: 'ICT share of 482 grants', value: '~12%', color: 'var(--terracotta)' },
        ].map(stat => (
